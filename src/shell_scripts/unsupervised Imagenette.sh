...
COMMAND="python -m neuro-inspired-defense.src.train_autoencoder --autoencoder_arch=top_T_dropout_quant_resize_autoencoder --dataset=Imagenette --defense_patchsize=8 --defense_stride=4 --dict_nbatoms=1000 --dict_iter=10000 --dict_lambda=0.5 --top_T=100 --dropout_p=0.95 --test_batch_size=32  --classifier_arch=efficientnet --classifier_epoch=100"
echo $COMMAND
eval $COMMAND
